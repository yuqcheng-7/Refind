export const materialDemo = [
  {
    ...
    body: '这份资料复盘了内容社区增长的三个阶段。\n\n冷启动阶段优先聚焦一个明确人群，以高频、可复用的内容建立信任。\n\n增长阶段通过评论互动、收藏回访和创作者激励，缩短用户从浏览到行动的路径。\n\n规模化后持续观察留存、搜索回流与内容供给的平衡，验证增长是否可以复制。',
  },
  {
    id: 'm2',
    kind: 'link',
    ...
    body: '资料从目标客户画像开始，说明团队如何用访谈和使用数据确认产品价值。完成 PMF 验证后，团队将首次关键行为作为激活指标，并为不同角色设计引导路径。',
    caption: '围绕 PMF 验证、激活指标与可复制获客渠道，梳理 SaaS 从早期验证走向规模化的增长节奏。完成验证后，关注续费与扩展使用。',
    subtitles: '大家好，今天想复盘我们从 0 到 1 的增长路径。\n先确认目标客户，再定义首次关键行为。\n规模化阶段不只看新增，还要看续费质量。',
  },
  {
    id: 'm3',
    kind: 'file',
    ...
    body: '已解析正文显示，运营团队按新用户、规律学习者和沉默用户划分触达策略。\n\n新用户先完成首个学习闭环；规律学习者通过阶段反馈维持动力；沉默用户则收到与其历史目标相关的低打扰提醒。\n\n转化并非独立活动，而是服务体验自然延伸的结果。',
  },
  {
    id: 'm4',
    kind: 'link',
    ...
    body: '这份清单按用途归纳了十一类设计参考：组件与模式库、品牌案例、动态叙事、字体与版式、三维与实验性界面。\n\n阅读时可记录具体页面为何有效，再转化为可复用的设计判断，而不是只保存视觉截图。',
  },
];
